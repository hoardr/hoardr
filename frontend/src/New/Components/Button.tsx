...
import {ButtonHTMLAttributes, ComponentProps, FC, PropsWithChildren} from "react";

export type SvgIcon = FC<ComponentProps<'svg'>>
export type ButtonType = 'default' | 'success' | 'primary'
...
export function Button({children, icon: Icon, type, className, onClick}: ButtonProps & Pick<ButtonHTMLAttributes<HTMLButtonElement>, 'onClick'>) {
